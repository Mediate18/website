<div class="col-xs-12 footer ds">
	<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
		...
		<ul class="list-inline">
			<li><a href="https://footprints.ccnmtl.columbia.edu/" target="_blank"><img class="partner-logo2" src="img/footprints.png" /></a></li>
			<li><a href="http://www.ustc.ac.uk/" target="_blank"><img class="partner-logo2" src="img/ustc.png" /></a></li>
			<li><a href="http://www.kb.nl/" target="_blank"><img class="partner-logo" src="img/kblogo.svg" /></a></li>
		</ul>
	</div>
	<div class="col-xs-12">
		<p class="footer-text">&copy; 2016 Radboud University</p>
	</div>
</div>
