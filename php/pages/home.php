...
<div class="col-xs-12 page-content">
	...
	<p>
		Developing an <b>interoperative, state-of-the-art database</b>, the MEDIATE project will, firstly, identify not the &quot;high&quot; Enlightenment texts studied by the history of ideas, and not the &quot;low&quot;, forbidden texts of book history, but the <b>real bestsellers of the 18th century</b>. To do so, it will create a fully searchable database of eighteenth-century library auction catalogues, in close collaboration with other existing historical bibliometric databases.
	</p>
	<p>
	...
	<p>
		The MEDIATE project thus brings a <b>bottom-up approach</b> to intellectual history, using book history data and new digital tools to argue that the Enlightenment was fashioned not only by the progressive intellectuals we know today, but just as importantly, also by a large mass of forgotten, middlebrow bestsellers that need to be adequately studied if we are to truly understand how we &quot;became modern&quot; (or not).
	</p>
</div>